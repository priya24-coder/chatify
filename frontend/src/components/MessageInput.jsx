  ...
  return (
    <div className="p-4 border-t border-slate-700/50">
        ...
        <div className="max-w-3xl mx-auto mb-3 flex items-center">
          <div className="relative">
            ...
            <button
              ...
              flex items-center justify-center text-slate-200 hover:bg-slate-700"
            >
      ...
      >
        ...
        className="bg-gradient-to-r from-cyan-500 to-cyan-500 text-white rounded-lg px-4 py-2
